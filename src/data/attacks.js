// Attaques du Wi-Fou maléfique contre l'Esprit Familial
...
export const ATTACKS = {
  ...
  1: {
    ...
    chapter: 1,
    difficulty: 'easy',
    description: `Le Wi-Fou a ensorcelé le smartphone de Léa ! Son téléphone vibre toutes les 30 secondes avec des notifications "URGENT ! Nouvelle vidéo de ton influenceur préféré !" 
...
La famille s'inquiète : Léa devient de plus en plus isolée et irritable quand on lui demande de poser son téléphone.`,
  ...
  2: {
    ...
    chapter: 1,
    difficulty: 'easy',
    description: `Le Wi-Fou a hypnotisé la tablette familiale ! Elle affiche en permanence des publicités flashy avec des messages "LIMITED TIME ! -90% sur tout ! Plus que 2h !" 
...
Les achats s'accumulent, le budget familial explose, et personne ne se rend compte qu'ils achètent des choses dont ils n'ont pas vraiment besoin.`,
  ...
  3: {
    ...
    chapter: 1,
    difficulty: 'medium',
    description: `Le Wi-Fou a ensorcelé tous les écrans de la maison ! À table, chacun regarde son téléphone au lieu de se parler. 
...
Les repas sont silencieux, les conversations familiales ont disparu. Chacun vit dans sa bulle numérique, isolé des autres. L'esprit familial se désagrège.`,
  ...
  4: {
    ...
    chapter: 1,
    difficulty: 'medium',
    description: `Le Wi-Fou a ensorcelé la console de Tom ! Elle crie maintenant "LEVEL UP ! Tu es si proche du niveau suivant ! Juste 5 minutes de plus !" 
...
Ses parents sont inquiets : Tom a des cernes, il maigrit, et il ne pense plus qu'au jeu. Il a perdu toute notion du temps et des priorités.`,
  ...
  5: {
    ...
    chapter: 2,
    difficulty: 'medium',
    description: `Le Wi-Fou a renforcé ses pouvoirs ! Maintenant, tous les appareils de la famille vibrent simultanément toutes les 30 secondes avec des messages alarmants :
...
La famille devient anxieuse, stressée, incapable de se concentrer sur autre chose. Ils vérifient constamment leurs téléphones, même la nuit. L'anxiété numérique s'installe.`,
  ...
  6: {
    ...
    chapter: 2,
    difficulty: 'hard',
    description: `Le Wi-Fou a ensorcelé les réseaux sociaux ! Ils montrent maintenant à chacun des images "parfaites" d'autres familles : maisons luxueuses, vacances paradisiaques, enfants parfaits...
...
L'estime de soi s'effondre. Ils oublient leurs propres qualités et se concentrent sur ce qu'ils n'ont pas. L'esprit familial devient négatif et destructeur.`,
  ...
  7: {
    ...
    chapter: 2,
    difficulty: 'hard',
    description: `Le Wi-Fou a créé une dépendance aux likes et aux commentaires ! Chaque membre de la famille publie frénétiquement sur les réseaux sociaux, attendant désespérément la validation des autres.
...
Ils deviennent esclaves des réactions des autres, perdant leur authenticité et leur liberté d'être eux-mêmes.`,
  ...
  8: {
    ...
    chapter: 2,
    difficulty: 'hard',
    description: `Le Wi-Fou a ensorcelé les algorithmes ! Maintenant, chaque membre de la famille ne voit que des informations qui confirment ses préjugés et ses peurs.
...
Les disputes éclatent, chacun pense avoir raison, la vérité devient relative. L'esprit familial se divise sur des fausses informations.`,
  ...
  9: {
    ...
    chapter: 3,
    difficulty: 'hard',
    description: `Le Wi-Fou révèle sa vraie nature ! Il tente maintenant de posséder complètement l'esprit familial. Tous les écrans crient simultanément :
...
La famille est tiraillée entre la tentation de se laisser aller et la résistance. Le Wi-Fou promet bonheur, réussite, popularité... mais au prix de leur liberté et de leur authenticité.`,
    target: 'Toute la famille',
  ...
  10: {
    ...
    chapter: 3,
    difficulty: 'hard',
    description: `Le Wi-Fou essaie de diviser les Gardiens ! Il chuchote à chacun des mensonges sur les autres :
...
Les Gardiens commencent à se méfier les uns des autres, à se disputer, à se replier sur eux-mêmes. Le Wi-Fou ricane : divisés, ils seront plus faciles à vaincre !`,
    target: 'Les Gardiens',
  ...
  11: {
    ...
    chapter: 3,
    difficulty: 'hard',
    description: `Le Wi-Fou propose un faux compromis ! Il prétend vouloir libérer la famille :
...
Mais c'est un piège ! Le Wi-Fou veut que la famille choisisse librement de devenir ses esclaves, pour qu'elle ne puisse plus jamais se rebeller. C'est la manipulation la plus subtile.`,
    target: 'Toute la famille',
  ...
  12: {
    id: 12,
    title: 'Le Retour du Wi-Fou',
    chapter: 3,
    difficulty: 'boss',
    description: `Le Wi-Fou révèle sa forme ultime ! Il devient un géant numérique qui engloutit toute la maison dans une tempête de données, d'images, et de sons hypnotiques.
